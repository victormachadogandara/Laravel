    ...
    <div class="cards">
        ...
        <div class="card card-small">
            <div class="card-body">
                ...
                <p>
                    Con Composer podemos instalar y actualizar frameworks como Laravel o Symfony, así como componentes para generar PDF, procesar pagos con tarjetas, manipular imágenes y mucho más.
                </p>
            </div>
    ...
    Route::get('/', function () {
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p>
                    Front Controller es un patrón de arquitectura donde un controlador maneja todas las solicitudes o peticiones a un sitio web.
                </p>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p>
                    Puedes colocar el siguiente código en el método <code>boot</code> de <code>app/Providers/RouteServiceProvider.php</code> para restringir cualquier parámetro de las rutas a un formato numérico:
                </p>
